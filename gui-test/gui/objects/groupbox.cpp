...
namespace snekUI {
	...
	void group::draw( ) {
		...
		render.text( { group_title_area.x + 4, group_title_area.y + ( group_title_area.h / 2 ) - ( title_text_size.h / 2 ) } , this->title , parent_window.title_font , parent_window.theme.titletext_color );
